...
var testCases = [...]testData{
	...
	},
	{
		input:          "asdf",
		padding:        2,
		expectedResult: "QuickRootedSwing5012",
	},
	{
		input:          "asdf",
		padding:        4,
		expectedResult: "QuickRootedSwing5012F6C6",
	},
	{
		input:          "asdf",
		padding:        8,
		expectedResult: "QuickRootedSwing5012F6C60B27661C",
	},
	{
		input:          "asdf",
		padding:        999,
	...
	// Test a few unique UUID:s
	{
		...
		padding:        1,
		expectedResult: "SomewhatCleanPearF4",
	},
	{
		input:          "3e3278cd-6030-400d-9c0d-ef9be0119853",
		padding:        5,
		expectedResult: "QuickTipsyBobA2DEC84AEE",
	},
	{
		input:          "6745dc33-2fbd-4311-8884-10aab93199a9",
		padding:        7,
		expectedResult: "NextSluggishSwing7F2343BF6927EA",
	},
	// Big data blob
	{
